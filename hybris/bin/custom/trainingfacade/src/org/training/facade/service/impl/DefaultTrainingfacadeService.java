...
public class DefaultTrainingfacadeService implements TrainingfacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingfacadeService.class);
	...
	{
		return DefaultTrainingfacadeService.class.getResourceAsStream("/trainingfacade/sap-hybris-platform.png");
	}
