 ...
 */
@IntegrationTest
public class AssignDefaultMechanicServiceLayerCronJobTest extends ServicelayerTransactionalTest
{
	...
	{
		createCoreData();
		importCsv("/training/test/AssignDefaultMechanicServiceLayerCronJobTest.impex", "utf-8");
	}
	...
	public void testAssignDefaultMechanic() throws InterruptedException, ImpExException
	{
		...
		cronJobService.performCronJob(cronJobService.getCronJob("assignDefaultMechanicServiceLayerCronJob"), true);
