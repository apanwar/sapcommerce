...
<div class="account-section-header">
    <div class="row">
        <div class="container-lg col-md-6">
            ...
            <c:if test="${updateProfileForm.affiliationStatus eq 'APPROVED'}">
            	<img alt="Affiliate" src="${contextPath}/_ui/addons/affiliateprogramaddon/responsive/common/images/affiliate.jpg">
            </c:if>
        </div>
    </div>
</div>
    ...
    <div class="container-lg col-md-6">
        <div class="account-section-content">
            <div class="account-section-form">
                <form:form action="update-profile-affiliate" method="post" modelAttribute="updateProfileForm">
					...
					<c:if test="${updateProfileForm.affiliationStatus == null}">
						<formElement:formCheckbox idKey="profile.becomeAffiliate" labelKey="profile.becomeAffiliate" path="becomeAffiliate" inputCSS="text"/>
					</c:if>
                    <div class="row">
