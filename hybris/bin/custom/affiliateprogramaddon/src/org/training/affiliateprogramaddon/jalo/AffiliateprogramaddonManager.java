 ...
 */
package org.training.affiliateprogramaddon.jalo;
...
import org.training.affiliateprogramaddon.constants.AffiliateprogramaddonConstants;



/**
 * This is the extension manager of the Affiliateprogramaddon extension.
 */
public class AffiliateprogramaddonManager extends GeneratedAffiliateprogramaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AffiliateprogramaddonManager.class.getName());
	 ...
	 */
	public static AffiliateprogramaddonManager getInstance()
	{
		return (AffiliateprogramaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AffiliateprogramaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AffiliateprogramaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AffiliateprogramaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AffiliateprogramaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AffiliateprogramaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
