 ...
 */
package com.publicis.sapient.productregistrationaddon.jalo;
...
import com.publicis.sapient.productregistrationaddon.constants.ProductregistrationaddonConstants;



/**
 * This is the extension manager of the Productregistrationaddon extension.
 */
public class ProductregistrationaddonManager extends GeneratedProductregistrationaddonManager
{
	 ...
	 */
	public static ProductregistrationaddonManager getInstance()
	{
		return (ProductregistrationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductregistrationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductregistrationaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductregistrationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductregistrationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductregistrationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
