 ...
 */
package org.training.productsubscriptionaddon.jalo;
...
import org.training.productsubscriptionaddon.constants.ProductsubscriptionaddonConstants;



/**
 * This is the extension manager of the Productsubscriptionaddon extension.
 */
public class ProductsubscriptionaddonManager extends GeneratedProductsubscriptionaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductsubscriptionaddonManager.class.getName());
	 ...
	 */
	public static ProductsubscriptionaddonManager getInstance()
	{
		return (ProductsubscriptionaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductsubscriptionaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductsubscriptionaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductsubscriptionaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductsubscriptionaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductsubscriptionaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
